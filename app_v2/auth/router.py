...
from app_v2.auth.models import (
    RegisterRequest,
    LoginRequest,
    AuthResponse,
    LogoutResponse,
...
from app_v2.auth.dependencies import (
    get_firebase_auth,
    get_session_manager,
    require_auth,
    get_client_ip,
...
from app_v2.auth import pipelines
...
def get_user_service():
    ...
    from app_v2.user.dependencies import get_user_service as _get_user_service
