...
from app_v2.calendar.dependencies import (
...
from app_v2.calendar.models import (
...
async def get_user_availability(
    user: Annotated[dict, Depends(require_auth)],
    availability_service: Annotated[CalendarAvailabilityService, Depends(get_availability_service)],
    connection_service: Annotated[CalendarConnectionService, Depends(get_connection_service)],
